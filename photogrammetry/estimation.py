...
def estimate_essential_matrix(points1 : NDArray[Shape["3,Any"], Float],
...
def get_realizable_relpose_from_essential_matrix(
    ...
    best_rel_rotation = normalize(possible_cameras2[best_index].rotation_matrix, axis=1, norm='l2')
